...
public class PharmacyStore extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"JG Store", "nimra", "nimra 577", "A186 ", "2222222", "panadol", "2222", "333", "tabalate", "1-dec-2022", null},
            ...
            new String [] {
                "Store Name", "Owner Name", "Email", "Address", "Contact", "Medicine Name", "Quantity", "Order #", "Form", "Order Date", "Delivery Date"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO ammdd your handling code here:Text()
        jButton2();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jComboBox1.setSelectedItem(model.getValueAt(1,9).toString());
        jComboBox1.setSelectedItem(model.getValueAt(1,9).toString());
        jComboBox1.setSelectedItem(model.getValueAt(1,9).toString());
        jComboBox1.setSelectedItem(model.getValueAt(1,10).toString());
        jComboBox1.setSelectedItem(model.getValueAt(1,10).toString());
        jComboBox1.setSelectedItem(model.getValueAt(1,10).toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().equals("")||jTextField2.getText().equals("")||jTextField3.getText().equals("")||jTextField4.getText().equals("")|| jTextField5.getText().equals("") ||jTextField6.getText().equals("")||jTextField7.getText().equals("")|| jTextField8.getText().equals("")){
            ...
            mode1.setValueAt(jTextField7.getText(),i,6);
            mode1.setValueAt(jTextField8.getText(),i,7);
            mode1.setValueAt(jComboBox1.getSelectedItem(),i,8);
            mode1.setValueAt(jComboBox2.getSelectedItem(),i,9);
            mode1.setValueAt(jComboBox3.getSelectedItem(),i,9);
            mode1.setValueAt(jComboBox4.getSelectedItem(),i,9);
            mode1.setValueAt(jComboBox5.getSelectedItem(),i,10);
            mode1.setValueAt(jComboBox6.getSelectedItem(),i,10);
            mode1.setValueAt(jComboBox7.getSelectedItem(),i,10);
